...
Created 2026-08-20. Research: `research-skse-menu-framework.md`. Decision: ADR-0010 (supersedes ADR-0003).
...
- **ADR-0010** is the host decision. Do not keep ADR-0003's "own ImGui interface" as live policy.
