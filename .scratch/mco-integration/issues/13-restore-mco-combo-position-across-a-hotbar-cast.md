...
- [ ] A restore is consumed after its ready pass; a later ready/PIE cannot rewrite the index.
- [ ] Capture and restore do not race across the animation callback and the main loop.
