# Weapon Art icon prompt brief

Resolve this brief before writing or revising an image-generation prompt. The owner approves the
meaning; the agent owns the prompt engineering.

## Identity

- Ability and stable key:
- Player-facing verb: what does the ability do at a glance?
- Animation evidence: duration, travel, hit sequence, payloads, and recovery:
- Exact frozen moment:
- Provenance: distinguish animation-proven, payload-proven, owner-directed staging,
  Skyrim-reference-derived, and agent composition choices:
- Active animation resolution: OAR definition, winning provider, HKX path, and hash:
